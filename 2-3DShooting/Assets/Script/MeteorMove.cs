...
public class MeteorMove : MonoBehaviour
{
    ...
    public float meteorType;
    public float meteorRotateX;
    public float meteorRotateY;
    public float meteorRotateZ;
    ...
    [Header("Expload")]
    public float exploadScaleX;
    public float exploadScaleY;
    public float exploadScaleZ;
