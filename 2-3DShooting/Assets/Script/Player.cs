    ...
    private void PlayerMove()
    {
        ...
        switch (phaseNum)
        {
            case 0:
                ...
                //transform.position = new Vector3(horizontal, transform.position.y, vertical) * Time.deltaTime;
                //Vector3 PhaseMove1 = new Vector3(horizontal, 0.0f, vertical) * Time.deltaTime;
                //transform.position = PhaseMove1.normalized * Speed;
                //rigidbody.velocity = PhaseMove1.normalized * Speed;
            ...
            case 1:
                ...
                //var PhaseMove2 = new Vector3(transform.position.x, horizontal, vertical) * Time.deltaTime;
                //rigidbody.velocity = PhaseMove2.normalized * Speed;
            ...
            case 2:
                ...
                //var PhaseMove3 = new Vector3(horizontal, vertical, transform.position.z) * Time.deltaTime;
                //rigidbody.velocity = PhaseMove3.normalized * Speed;
